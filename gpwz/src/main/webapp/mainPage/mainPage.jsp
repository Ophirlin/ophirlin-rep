...
<html>
    ...
    <body>
            ...
            <ul class="horizontal-list nav-list">
                ...
                <li class="nav-item active" id="nav-item-5">
                    ...
                    <div class="subnav" id="subnav-5">
                        <div class="subnav-inset">
                            <ul class="subnav-list">
                                <li><a onclick="login()" class="nav-link-subsec">登录</a></li>
        ...
        <div class="log_reg_windows" id="log_reg_windows">
        	<div class="log" id="log_block">
        		<form action="">
        			邮箱<input type="email" name="email"><span id="log_message1"></span><br/>
        			密码<input type="password" name="password"><span id="log_message2"></span><br/>
        			<input type="button" name="submit1" value="登陆"><input type="button" name="submit2" value="取消" onclick="noLogin()">
        		</form>
        		<a>忘记密码？</a>
        	</div>
        	<div class="reg" id="reg_block">
        		<form action="">
        			邮箱<input type="email" name="email"><span id="reg_message1"></span><br/>
        			用户名<input type="email" name="email"><span id="reg_message2"></span><br/>
        			密码<input type="password" name="password"><br/>
        			重新输入密码<input type="password" name="password"><br/><span id="reg_message3"></span><br/>
        			<input type="button" name="submit1" value="注册"><input type="button" name="submit2" value="取消" onclick="noRegister()">
        		</form>
