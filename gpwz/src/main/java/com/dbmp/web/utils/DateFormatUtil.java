...
public class DateFormatUtil {
	 ...
	 * yyyy/MM/dd HH:mm:ss 时间格式
	 */
	public static final DateFormat DATETIME_FORMAT_SPRIT = new SimpleDateFormat(
			StringPool.DATE_FORMAT_SPRIT);
	/**
	 ...
	 */
	public static final DateFormat TIMESTAMP_FORMAT_NUMBER = new SimpleDateFormat(
			StringPool.DATE_FORMAT_TIMESTAMP_NUMBER);
	...
	public static Date getCurrentDateTime(){
		...
		try {
			//多线程方法中使用了共享变量SimpleDateFormat，
			//报如下错误：  java.lang.NumberFormatException: multiple points
			//dateTime = DateFormatUtil.parseDateTime(DateFormatUtil.getNowByString("yyyy-MM-dd HH:mm:ss"));
			DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			dateTime = dateFormat.parse(DateFormatUtil.getNowByString("yyyy-MM-dd HH:mm:ss"));
